...
type PainpointMinimalData = {
  painpoint: string;
};

type PainpointMinimalFormProps = PainpointMinimalData & {
  updateFields: (fields: Partial<PainpointMinimalData>) => void;
};

export function PainpointMinimalForm({
  painpoint,
  updateFields,
}: PainpointMinimalFormProps) {
  return (
